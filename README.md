...
es.add_dataframe("transactions", tx_lf, primary_key="id", row_creation_time="occurred_at")
...
- [Entity sets](docs/guide/entity-sets.md) — tables, keys and relationships.
- [Running DFS](docs/guide/dfs.md) — depth, cutoff times, and the column naming scheme.
