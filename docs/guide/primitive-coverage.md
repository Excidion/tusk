...
| Datetime transform | — | [`age`](https://featuretools.alteryx.com/en/stable/generated/featuretools.primitives.Age.html) | ⛔ |  | `time_since` already measures it; without semantic tags a birth date is just a datetime. |
