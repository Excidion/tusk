...
| Binary transform | [`equal`][tusk.primitives.Equal] | [`equal`](https://featuretools.alteryx.com/en/stable/generated/featuretools.primitives.Equal.html) | ✅ | [`test_comparisons_match_featuretools_where_nothing_is_null`](https://github.com/Excidion/tusk/blob/main/tests/differential/test_binary_transforms.py) / [`test_comparisons_agree_where_an_input_is_null`](https://github.com/Excidion/tusk/blob/main/tests/differential/test_binary_transforms.py) | Compares numbers, datetimes, booleans and strings. Labels have their own primitives. |
...
| Binary transform | [`greater_than`][tusk.primitives.GreaterThan] | [`greater_than`](https://featuretools.alteryx.com/en/stable/generated/featuretools.primitives.GreaterThan.html) | ✅ | [`test_comparisons_match_featuretools_where_nothing_is_null`](https://github.com/Excidion/tusk/blob/main/tests/differential/test_binary_transforms.py) / [`test_comparisons_agree_where_an_input_is_null`](https://github.com/Excidion/tusk/blob/main/tests/differential/test_binary_transforms.py) | featuretools also accepts Ordinal columns; tusk has no logical types. |
| Binary transform | [`greater_than_equal_to`][tusk.primitives.GreaterThanEqualTo] | [`greater_than_equal_to`](https://featuretools.alteryx.com/en/stable/generated/featuretools.primitives.GreaterThanEqualTo.html) | ✅ | [`test_comparisons_match_featuretools_where_nothing_is_null`](https://github.com/Excidion/tusk/blob/main/tests/differential/test_binary_transforms.py) / [`test_comparisons_agree_where_an_input_is_null`](https://github.com/Excidion/tusk/blob/main/tests/differential/test_binary_transforms.py) | featuretools also accepts Ordinal columns; tusk has no logical types. |
...
| Binary transform | [`modulo_numeric`][tusk.primitives.ModuloNumeric] | [`modulo_numeric`](https://featuretools.alteryx.com/en/stable/generated/featuretools.primitives.ModuloNumeric.html) | ⚠️ | [`test_modulo_matches_featuretools_on_negative_operands`](https://github.com/Excidion/tusk/blob/main/tests/differential/test_binary_transforms.py) / [`test_modulo_diverges_on_a_zero_divisor`](https://github.com/Excidion/tusk/blob/main/tests/differential/test_binary_transforms.py) | Floored, so the sign follows the divisor on every backend. Diverges on a zero divisor: tusk gives NaN, featuretools 0 — woodwork infers the fixture's whole-number columns as `Int64`, where pandas' `%` by zero is `0`. |
...
| Binary transform | — | [`multiply_boolean`](https://featuretools.alteryx.com/en/stable/generated/featuretools.primitives.MultiplyBoolean.html) | ⚠️ |  | Boolean multiplication is [`and`][tusk.primitives.And], which tusk already ships. |
