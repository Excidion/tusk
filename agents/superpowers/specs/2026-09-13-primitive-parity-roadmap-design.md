...
| --- | --- | --- | --- |
| 1 | Standalone aggregations | `all`, `any`, `n_true`, `skew`, `kurtosis`, `variance`, `max_min_delta`, `first_last_time_delta`, `is_unique`, `has_no_duplicates`, `percent_unique`, `n_unique_days`, `n_unique_days_of_calendar_year`, `n_unique_days_of_month`, `n_unique_months` | `skew`, `percent_true` join `AGG_DEFAULTS`; `day` joins `TRANS_DEFAULTS`; the ⛔ reclassifications below |
| 2 | Standalone and ordered transforms | `is_null`, `negate`, `square_root`, `sine`, `cosine`, `minute`, `second`, `day_of_year`, `is_leap_year`, `cum_mean`, `same_as_previous`, `absolute_diff`, `percent_change`, `percentile`, `cumulative_time_since_last_true`, `cumulative_time_since_last_false` | ⚠️ `cum_count`; ⚠️ `diff_datetime` → `time_since_previous`; ❓ tests for `cum_sum`, `cum_min`, `cum_max`, `diff`, `year`, `month`, `day`, `hour`, `absolute`, `natural_log` |
